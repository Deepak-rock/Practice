...
class App extends Component {
  ...
  getFilteredProjects = () => {
    ...
    const filteredProjects = (projectsList.filter(projectDetails => projectDetails.category === activeTabId))
  ...
  render() {
    ...
    return (
      <div className="app-container">
        ...
        <p className="description">Your skills and achievements   showcase your strengths and abilities.
          Speak about any new skills or software you learnt to perform the
          project responsibilities.</p>
        <ul className="tabs-container">
            {tabsList.map(tabDetails => (<TabItem 
        ...
        <ul className="project-list-container">
              {filteredProjects.map(eachProject => (
                <ProjectItem key= {eachProject.projectId} eachProject={eachProject}/>
              ))}
        </ul>
      </div>
    )
